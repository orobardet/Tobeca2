...
//Vous pouvez aussi optimiser vos réglages en suivant le tuto sur ce lien :
//http://www.tobeca.fr/comment-ameliorer-la-regulation-de-temperature-sur-marlin-avec-lautotune-pid/

//J-HEAD MK5 : 37.77, 3.58, 99.63
...
#define  DEFAULT_Kp 31.21
#define  DEFAULT_Ki 1.46
#define  DEFAULT_Kd 166.81
...
#define PANELONE //ECRAN LARGE nouvelle version
//#define LCD_I2C_PANELOLU2 //ECRAN HAUT (ancienne version Tobeca 2)
...
#define STRING_CONFIG_H_AUTHOR "Adrien Grelet - Tobeca SARL - www.tobeca.fr" // Who made the changes.
...
#define TEMP_SENSOR_BED 1 //Plateau (toujours laisser à 1)
...
//from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    #define  DEFAULT_bedKp 10 //10.00
    #define  DEFAULT_bedKi 0.023 //0.023
    #define  DEFAULT_bedKd 305.4 //305.4
...
const bool Z_MIN_ENDSTOP_INVERTING = false; // mettre true si l'autobed est activé, sinon mettre false
...
#define DEFAULT_MAX_FEEDRATE          {500, 500, 2, 60}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000,1000,50,15000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
...
//SUPPORT DES ECRANS LCD POUR TOBECA 2 ET TOBECA SUR MESURE
//LCD and SD support
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 96,30} // X,Y,Z Axis Extend and Retract angles
